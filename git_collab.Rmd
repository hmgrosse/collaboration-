...
```{r}
#its using data in the month by month form - but I keep getting the "longer object length is not a multiple of shorter object length"
#I thought the complete might help fill some of the length issues - it did not
hurricane_sandy <- price_by_month %>% 
  ...
  #complete(RegionName, 
           #month_average, 
           #fill = list(value = 0)) %>% 
  filter(month_average == c("2012-01","2012-02","2012-03","2012-04","2012-05","2012-06","2012-07","2012-08","2012-09","2012-10","2012-11","2012-12","2013-01","2013-02","2013-03","2013-04","2013-05","2013-06","2013-07","2013-08","2013-09","2013-10","2013-11","2013-12"),
    RegionName == c("florida", "georgia", "south carolina", "north carolina", "virginia", "maryland", "deleware", "pennsylvania", "new jersey", "new york", "connceticut", "rhode island", "massacheusettes", "new hampshire", "maine")) %>% 
  ggplot(aes(y = value, 
             x = month_average)) +
  geom_line() + 
